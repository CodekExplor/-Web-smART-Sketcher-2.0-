...
4. Wybierz lub przeciągnij obraz PNG, JPG, WEBP albo BMP. Możesz też wkleić bezpośredni adres HTTPS obrazu i kliknąć **Wczytaj z URL**. Serwer obrazu musi zezwalać na pobieranie z innych witryn (CORS); link do strony z obrazem nie wystarczy.
...
6. Aby wykadrować obraz, powiększ go i przeciągnij podgląd. Położenie można też ustawić suwakami X/Y lub strzałkami, z klawiszem Shift po 5 px. Suwak **Grubość linii** ścieśnia albo pogrubia kreski; **Kontrast** i **Jasność** pozwalają dopasować wygląd projekcji.
7. Sprawdź końcowy podgląd i kliknij **Wyślij do projektora**. Przycisk **Resetuj ustawienia** przywraca skalę, obrót, położenie, grubość, kontrast i jasność do wartości początkowych.

Obraz jest przetwarzany lokalnie w przeglądarce. Przy użyciu URL przeglądarka pobiera go bezpośrednio z podanego serwera; aplikacja nie przesyła go na własny serwer. Kadrowanie i suwaki wyglądu zmieniają dokładnie ten sam obraz 160 × 128 RGB565, który jest pokazywany w podglądzie i wysyłany do projektora. Skala działa względem wybranego trybu Dopasuj/Wypełnij; przy zmniejszeniu mogą pojawić się białe marginesy. PWA można zainstalować z menu Chrome/Edge; działa nadal w przeglądarkowym runtime i wymaga dostępnego Bluetooth.
...
1. Otwórz [adres z numerem wersji](https://codekexplor.github.io/-Web-smART-Sketcher-2.0-/?v=20260924-7). Na dole strony musi być napis **Wersja 2026.09.24.7**. Zamknij wcześniej otwartą kartę lub zainstalowaną PWA. Zasoby JS/CSS mają numer wersji w adresie, a service worker pobiera aktualną wersję z sieci.
